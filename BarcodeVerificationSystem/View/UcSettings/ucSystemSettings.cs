...
namespace BarcodeVerificationSystem.View
{
    public partial class UcSystemSettings : UserControl
    {
        ...
        private void SetLanguage()
        {
            ...
            radEnableDuplicatedDB.Text = radEnableOneForAll.Text= radEnableImageExport.Text = radEnableOutput.Text = Lang.Enable;
            radDisableDuplicatedDB.Text = radDisableOneForAll.Text = radDisableImageExport.Text = radDisableOutput.Text = Lang.Disable;
